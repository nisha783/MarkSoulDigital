        ...
        <div class="col-md-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card  shadow-lg card-body text white" style="background-color: #1f6f78;">
                    ...
                    <form action="{{ route('user.withdraw.store') }}" method="POST">
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-large btn-label text-white" style="background-color: #1f6f78;"> Withdraw Reqeust <i
