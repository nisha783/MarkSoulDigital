                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.deposit.store') }}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" class="form-control"
                                        ...
                                        <small class="" style="color: #1f6f78;">Please Enter Amount in only USD</small>
                                </div>
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-large btn-label text-white" style="background-color: #1f6f78;"> Continue <i
