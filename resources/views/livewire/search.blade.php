        ...
        <div class="row">
            <div class="col-6 col-md-3 mb-3 d-flex justify-content-center align-items-center">
                <a href="{{ route('user.dashboard.index') }}"
                    class="btn btn-large d-flex justify-content-center align-items-center gap-2 text-white" style="background-color: #F52549;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <button class="btn btn-large text-white" wire:click="searchUser" type="button"
                            id="button-addon2" style="background-color: #F52549;">Search</button>
                    </div>
                </div>
            </div>
        </div>
